            ...
            <div class="panel-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="skillname" class="form-control" value="<?php echo $skillname ?>" required>
                </div>
                ...
                <div class="form-group">
                  <button type="submit" name="skillcreate" class="btn btn-success">Create</button>
