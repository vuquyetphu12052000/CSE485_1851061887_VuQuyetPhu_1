            ...
            <div class="panel-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="experience_name" class="form-control" value="<?php echo $experience['work'] ?>" required>
                </div>

                <div class="form-group">
                  <label for="">Time</label>
                  <input type="text" name="time" class="form-control" value="<?php echo $experience['time'] ?>" required>
                </div>

                <div class="form-group">
                  <label for="">Description</label>
                  <input type="text" name="description_short" class="form-control" value="<?php echo $experience['description'] ?>" required>
                </div>

                <div class="form-group">
                  <button type="submit" name="experienceedit" class="btn btn-success">Update</button>
                  <a class="btn btn-success" href="experience.php">Cancel</a>
                </div>
              </form>
            </div>
          </div>
