            ...
            <div class="panel-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="portfolio_name" class="form-control" value="<?php echo $portfolios['portfolio_name'] ?>" required>
                </div>
                ...
                <div class="form-group">
                  <button type="submit" name="portfolioedit" class="btn btn-success">Update</button>
